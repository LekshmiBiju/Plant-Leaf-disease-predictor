...
for epoch in range(1, num_epochs + 1):
    ...
    if val_accuracy > best_accuracy:
        ...
        print("New best Day 12 model saved!")
...
# KEEPING YOUR ORIGINAL 5 FINE-TUNING EPOCHS
...
print("\n================================")
print("FINAL DAY 12 RESNET18 RESULTS")
print("================================")
...
with open(
    "reports/resnet18_day12_metrics.txt",
    "w"
) as f:

    f.write(
        "ResNet18 Day 12 Transfer Learning\n"
    )
